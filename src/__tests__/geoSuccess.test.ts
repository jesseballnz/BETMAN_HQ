...
describe('buildGeoSuccessSummary', () => {
  test('counts owned landing countries and areas for Geo Success bars', () => {
    ...
    expect(summary.rows).toEqual([
      { countryCode: 'NZ', country: 'New Zealand', landingSessions: 227, areas: 2, sharePct: expect.closeTo(79.649, 3) },
      { countryCode: 'AU', country: 'Australia', landingSessions: 58, areas: 1, sharePct: expect.closeTo(20.351, 3) },
      { countryCode: 'HK', country: 'Hong Kong', landingSessions: 0, areas: 0, sharePct: 0 },
    ]);
  });
});
