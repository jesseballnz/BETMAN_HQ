...
const FIELD_GROUPS: { title: string; fields: FieldConfig[] }[] = [
  {
    ...
    fields: [
      ...
      {
        key: 'terminalUnitPriceNZD',
        label: 'BETMAN Terminal Price',
        description: 'Price per BETMAN Terminal',
        prefix: 'NZ$',
        suffix: '/terminal',
        step: 25,
        min: 0,
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'stridesReportPriceNZD',
        label: 'Strides Report Price',
        description: 'Average Strides sale price per horse report',
        prefix: 'NZ$',
        suffix: '/report',
        step: 25,
        min: 0,
      ...
      {
        key: 'stridesKarakaSales',
        label: 'Karaka Strides Sales',
        description: 'Forecast Strides reports sold around Karaka',
        suffix: 'reports',
        step: 1,
        min: 0,
      },
      {
        key: 'stridesGoldCoastSales',
        label: 'Gold Coast Strides Sales',
        description: 'Forecast Strides reports sold around Gold Coast',
        suffix: 'reports',
        step: 1,
        min: 0,
      },
      {
        key: 'terminalSalesPerMonth',
        label: 'BETMAN Terminal Sales',
        description: 'Average terminals sold per month at NZ$250 each',
        suffix: '/month',
        step: 1,
        min: 0,
      },
